...
인물 299 · 사건 266 · 장소 86(실제 65, 이야기 속 21) · 묶음서사 33 · 타래 2 · 원전 13
...
「제우스가 만난 이들과 그 아이들」(메티스에서 레다까지 열 단계, era 2~5). 같은 시대 안에서 앞뒤를 원전이 말하지 않는
...
- **이야기** — 위에 타래 둘, 아래에 묶음 서른셋. 타래의 단계 사이에 순서를 모르는 곳은 "옛 책에 없다"고 적혀 있다.
